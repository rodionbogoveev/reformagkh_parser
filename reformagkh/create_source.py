...
while True:
    address = input(
        ...
        ' "Санкт-Петербург, ул. Репищева, д. 21, к. 1" или "Краснодарский, г. '
        'Анапа, ул. Ленина, д. 134".\nЕсли вы хотите ввести адрес отдельными '
        'параметрами, то оставьте это поле пустым и нажмите Enter.\n'
        'Поле для ввода: '
    )
    print()
    if not address:
